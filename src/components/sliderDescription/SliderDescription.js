...
const SliderDescription = ({title, description,link}) => {
    return (
        <div className="flex flex-col justify-center py-16 px-8 space-y-4 box-border	row-start-2 row-end-3 md:row-start-1 md:row-end-2 md:col-start-2 md:col-end-3 lg:col-start-4 lg:col-end-6 "> 
